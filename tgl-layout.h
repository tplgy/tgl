...
#define TGLCHF_CREATED (1 << 0)
#define TGLCHF_CREATE 0x80000000
#define TGLCHF_KICKED (1 << 4)
#define TGLCHF_CREATOR (1 << 6)
#define TGLCHF_ADMIN (1 << 5)
#define TGLCHF_OFFICIAL (1 << 3)
#define TGLCHF_LEFT (1 << 7)
#define TGLCHF_DEACTIVATED (1 << 8)
