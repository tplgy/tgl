...
public:
    ...
    virtual void update_notification_settings(int32_t peer_id, tgl_peer_type peer_type, int32_t mute_until, bool show_previews, const std::string& sound, int32_t event_mask) = 0;
