...
#ifndef __TGL_QUERY_MESSAGES_SEND_ENCRYPTED_ACTION_H__
#define __TGL_QUERY_MESSAGES_SEND_ENCRYPTED_ACTION_H__
...
public:
    query_messages_send_encrypted_action(
        ...
        : query_messages_send_encrypted_base("send encrypted action", secret_chat, message, callback)
    {
    }
