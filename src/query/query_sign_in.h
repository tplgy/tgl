...
class query_sign_in: public query_with_timeout
{
public:
    query_sign_in(user_agent& ua, double timeout_seconds, const std::function<void(bool, const std::shared_ptr<user>&)>& callback);
