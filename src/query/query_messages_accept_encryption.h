...
#ifndef __TGL_QUERY_MESSAGES_ACCEPT_ENCRYPTION_H__
#define __TGL_QUERY_MESSAGES_ACCEPT_ENCRYPTION_H__
...
{
public:
    query_messages_accept_encryption(const std::shared_ptr<tgl_secret_chat>& secret_chat,
