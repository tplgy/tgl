...
struct tgl_file_location {
    ...
    // regular files
    long long volume() { return m_volume; }
    int local_id() { return m_local_id; }
    long long secret() { return m_secret; }

    // documents
    long long document_id() { return m_volume; }
    long long access_hash() { return m_secret; }
private:
    int m_dc;
