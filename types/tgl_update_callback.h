...
public:
    ...
    virtual void message_sent(long long old_msg_id, long long new_msg_id, int chat_id) = 0;
    ...
    virtual void new_user(int user_id, const std::string &phone, const std::string &firstname,
                     const std::string &lastname, const std::string &username, long long access_hash) = 0;
    ...
    virtual void chat_update(int chat_id, int peers_num, const std::string &title) = 0;
